...
import tetrisLogo from '@/assets/tetris-loadspace-logo.png';

export function TetrisLoadSpaceBanner() {
  return (
    <a
      href="https://pack-my-trailer.lovable.app/"
      target="_blank"
      rel="noopener noreferrer"
      className="group block mt-2"
    >
      <div className="relative overflow-hidden rounded-lg mx-auto max-w-2xl border border-emerald-500/30 bg-gradient-to-r from-[hsl(145,60%,20%)] via-[hsl(160,50%,28%)] to-[hsl(180,60%,22%)] p-[1.5px] shadow-md transition-shadow hover:shadow-lg hover:shadow-emerald-500/20">
        <div className="relative overflow-hidden rounded-[7px] bg-gradient-to-r from-[hsl(145,60%,14%)] via-[hsl(160,50%,22%)] to-[hsl(180,50%,18%)] px-5 py-2.5">
