...
const services = [
  ...
  },
  {
    ...
    description:
      "Flexible LTL freight options for palletized shipments with dependable transit times, appointment coordination, and clear communication from pickup to delivery.",
  },
  {
    icon: Layers,
  ...
  },
  {
    ...
    description:
      "Time-critical freight solutions for urgent shipments, with fast response, priority scheduling, and proactive updates from dispatch to delivery. Perfect for last-minute construction or oilfield loads that must move now.",
  },
];
        ...
        <section className="pt-40 pb-20 bg-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mt-4 mb-6">
              ...
              <span className="text-patriot-red">Truckload, LTL, Flatbed & Expedited</span>
            </h1>
            <p className="text-primary-foreground/70 text-lg max-w-3xl mx-auto">
              Connecting shippers with vetted carriers for construction machinery freight,
              construction materials shipping, and oilfield freight brokerage across the U.S. and Canada.
            </p>
          </div>
        </section>
